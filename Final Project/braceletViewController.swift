...
class braceletViewController: UIViewController {
    ...
    */
    ...
    @IBAction func braceletURL(_ sender: UIButton) {
        UIApplication.shared.open(URL(string: "https://www.youtube.com/watch?v=nNOioNDsg2s")! as URL, options:[:], completionHandler: nil)
